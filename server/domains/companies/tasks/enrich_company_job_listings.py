...
# Configuration
BATCH_SIZE = 15  # Process 13 job listings at a time


@shared_task(name="domains.companies.tasks.enrich_company_job_listings")
    ...
    try:
        ...
        logger.info(
            ...
            extra={
                ...
                "elapsed_time": f"{request_time * 1000:.0f} ms",
            },
        )
